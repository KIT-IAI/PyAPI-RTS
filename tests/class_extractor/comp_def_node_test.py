...
class CompDefNodeTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(cdn.type, NodeType.NC_LINKED)
    ...
    def test_as_ext_conn_point(self):
        ...
        """
        cdn = CompDefNode(
            "name", "$x", "$y", NodeIO.OUTPUT, NodeType.NC_LINKED, "link", "phase"
        )
        ...
        with self.assertRaises(ValueError):
            cdn = CompDefNode(
                "name", "x", "y", NodeIO.UNDEFINED, NodeType.NC_LINKED, "link", "phase"
            )
